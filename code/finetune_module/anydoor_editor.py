...
from code.anydoor.cldm.model import create_model, load_state_dict
from code.finetune_module.ddim_hacked import DDIMSampler
from code.anydoor.cldm.hack import disable_verbosity, enable_sliced_attention
from code.anydoor.datasets1.data_utils import get_bbox_from_mask, expand_image_mask, pad_to_square, sobel, expand_bbox, box2squre, box_in_box
cv2.setNumThreads(0)
...
config = OmegaConf.load('./code/anydoor/configs/inference.yaml')
...
def inference_single_image(ref_image, ref_mask, tar_image, tar_mask, guidance_scale = 5.0):
    ...
    ddim_steps = 25 #gr.Slider(label="Steps", minimum=1, maximum=100, value=20, step=1)
